...
class EHttpServerDecoder: virtual public EProtocolDecoder {
public:
...
private:
	...
	sp<EHttpRequestImpl> parseHttpRequestHead(EIOByteBuffer* buffer);
};

} /* namespace eio */
} /* namespace efc */
#endif /* EHTTPSERVERDECODER_HH_ */
