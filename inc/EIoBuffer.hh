...
public:
     ...
     * @return the EIoBuffer*
     */
	virtual EIoBuffer* get(EA<byte>* dst);

    /**
     * Get a new EIoBuffer* containing a slice of the current buffer
     *
     * @param index The position in the buffer
     * @param length The number of bytes to copy
     * @return the new EIoBuffer*
     */
     ...
     * Writes the content of the specified <tt>src</tt> into this buffer.
     *
     * @param src The source EIoBuffer*
     * @return the modified EIoBuffer*
     */
     ...
     *
     * @param index The index in the EIoBuffer* where we will read a char from
     ...
     *
     * @param index The index in the EIoBuffer* where we will put a char in
     * @param value The char to put at the current position
     * @return the modified EIoBuffer*
     */
     ...
     * @see ByteBuffer#getShort()
     *
     * @param index The index in the EIoBuffer* where we will read a short from
     * @return The read short
     */
     ...
     * @param index The index in the EIoBuffer* where we will read an int from
     ...
     * @param value The int to put in the EIoBuffer*
     * @return the modified EIoBuffer*
     * @return the modified EIoBuffer*
     */
     ...
     *
     * @param value The log to put in the EIoBuffer*
     * @return the modified EIoBuffer*
     */
     ...
     *
     * @param index The index in the EIoBuffer* where we will read a long from
     ...
     * @param value The long to put in the EIoBuffer*
     * @return the modified EIoBuffer*
     * @return the modified EIoBuffer*
     */
     ...
     *
     * @param value The float to put in the EIoBuffer*
     * @return the modified EIoBuffer*
     */
     ...
     *
     * @param index The index in the EIoBuffer* where we will read a float from
     ...
     *
     * @param value The double to put at the EIoBuffer* current position
     * @return the modified EIoBuffer*
     */
     ...
     * @param value The double to put in the EIoBuffer*
     * @return the modified EIoBuffer*
     */
     ...
     *
     * @param val The CharSequence to put in the EIoBuffer*
